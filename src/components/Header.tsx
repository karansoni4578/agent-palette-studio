...
const Header = () => {
  ...
  return <header className="bg-background/80 backdrop-blur-sm border-b border-border sticky top-0 z-50">
      {/* Navigation */}
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo and Brand Name */}
          <div className="flex items-center space-x-3">
            <img src="/lovable-uploads/3be4ca71-2849-4870-8b9b-226aed931d60.png" alt="AI Agent Zone" className="max-h-14 overflow-auto " />
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 max-h-96 overflow-y-auto bg-background border border-border shadow-lg">
                {categories.map(category => <DropdownMenuItem key={category.href}>
