...
const LatestBlogs = () => {
  ...
  return <section className="py-12 px-4 sm:px-6 lg:px-8 bg-accent/10">
      <div className="max-w-7xl mx-auto">
        ...
        align: "center",
        loop: true
      }} setApi={setCarouselApi} className="relative">
          <CarouselContent className="h-24 sm:h-28 md:h-32">
            {blogPosts.map(blog => <CarouselItem key={blog.id} className="basis-4/5 sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5">
                ...
                damping: 30
                    ...
                    <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-lg overflow-hidden bg-muted flex-shrink-0">
                      {blog.image_url ? <img src={blog.image_url} alt={blog.title} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" loading="lazy" /> : <div className="w-full h-full bg-primary/10 flex items-center justify-center">
