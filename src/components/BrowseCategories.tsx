...
import { MessageCircle, PenTool, Code, Palette, Video, Mic, Settings, Megaphone, Zap, DollarSign, GraduationCap, Scale, Heart, Beaker, Users, BarChart3, Shield } from "lucide-react";
interface Category {
  name: string;
  description: string;
